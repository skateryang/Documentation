...
**简介:**  EOS.IO 开创了一种全新的区块链架构，基于该架构搭建的去中心化应用可以实现垂直和水平扩展。它通过构建一个可以在上面编写应用程序的类操作系统来实现这种能力。EOS.IO提供了账户、权限认证、数据库、异步通行、跨CPU跨集群应用调度等多种能力。由此产生的区块链架构技术，可最终实现100万笔交易/秒，用户免费使用，开发者可快速便捷的部署和维护去中性化应用程序等。

**PLEASE NOTE: CRYPTOGRAPHIC TOKENS REFERRED TO IN THIS WHITE PAPER REFER TO CRYPTOGRAPHIC TOKENS ON A LAUNCHED BLOCKCHAIN THAT ADOPTS THE EOS.IO SOFTWARE. THEY DO NOT REFER TO THE ERC-20 COMPATIBLE TOKENS BEING DISTRIBUTED ON THE ETHEREUM BLOCKCHAIN IN CONNECTION WITH THE EOS TOKEN DISTRIBUTION.**
**请注意**：本白皮书中提到的加密通证（Tokens）是指基于EOS.IO软件运行的区块链上的通证。不是指基于以太坊ERC-20标准协议发行的EOS通证。
